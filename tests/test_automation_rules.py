...
class AutomationRulePluginTests(unittest.TestCase):
    ...
    def test_editor_is_row_based_and_browser_permission_is_explicit(self):
        ...
        self.assertIn('automation_rules.css?v=1.1.4', template)
        ...
        self.assertIn('browser_sw.js?v=1.1.4', home)
        self.assertIn('data-operator=', template)
        self.assertIn("valueType === 'boolean'", editor)
        self.assertIn("'is_true'", editor)
        self.assertIn("'is_false'", editor)
        self.assertIn('expected.required = !booleanOperator', editor)
        self.assertIn("expected.type = 'number'", editor)
