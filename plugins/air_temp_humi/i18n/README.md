...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/air_temp_humi/i18n/ospy_messages.pot plugins/air_temp_humi/\*.py plugins/air_temp_humi/templates/\*.html 
