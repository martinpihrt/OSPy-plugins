...
``` bash
sudo python pygettext.py -a -v -d messages -o plugins/weather_based_water_level/i18n/ospy_messages.pot plugins/weather_based_water_level/\*.py plugins/weather_based_water_level/templates/\*.html 
```