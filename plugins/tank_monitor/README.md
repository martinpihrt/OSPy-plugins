...
Version 1.1.0 implements the read-only `ospy.provider.v1` contract for the single ultrasonic tank. Cached level, fill, distance and volume are available in stable units without triggering an I²C measurement.
...
Visit [Martin Pihrt's blog](https://pihrt.com/clanky/moje-raspberry-pi-plugin-ospy-vlhkost-pudy-a-mozstvi-vody-v-tankua). for more information.
