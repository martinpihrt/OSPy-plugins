...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/tank_monitor/i18n/ospy_messages.pot plugins/tank_monitor/\*.py plugins/tank_monitor/templates/\*.html 
