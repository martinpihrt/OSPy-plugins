...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/pulse/i18n/ospy_messages.pot plugins/pulse/\*.py plugins/pulse/templates/\*.html 
