...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/system_info/i18n/ospy_messages.pot plugins/system_info/\*.py plugins/system_info/templates/\*.html 
