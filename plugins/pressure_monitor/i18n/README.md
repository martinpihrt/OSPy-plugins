...
``` bash
sudo python pygettext.py -a -v -d messages -o plugins/pressure_monitor/i18n/ospy_messages.pot plugins/pressure_monitor/\*.py plugins/pressure_monitor/templates/\*.html 
```