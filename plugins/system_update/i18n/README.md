...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/system_update/i18n/ospy_messages.pot plugins/system_update/\*.py plugins/system_update/templates/\*.html 
