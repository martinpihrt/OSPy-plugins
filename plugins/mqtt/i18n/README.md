...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/mqtt/i18n/ospy_messages.pot plugins/mqtt/\*.py plugins/mqtt/templates/\*.html 
