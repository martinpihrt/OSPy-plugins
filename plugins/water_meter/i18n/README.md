...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/water_meter/i18n/ospy_messages.pot plugins/water_meter/\*.py plugins/water_meter/templates/\*.html 
