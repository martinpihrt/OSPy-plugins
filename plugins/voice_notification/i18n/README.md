...
``` bash
sudo python pygettext.py -a -v -d messages -o plugins/voice_notification/i18n/ospy_messages.pot plugins/voice_notification/\*.py plugins/voice_notification/templates/\*.html 
```