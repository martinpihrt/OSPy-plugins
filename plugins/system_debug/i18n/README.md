...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/system_debug/i18n/ospy_messages.pot plugins/system_debug/\*.py plugins/system_debug/templates/\*.html 
