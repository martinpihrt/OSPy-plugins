...
``` bash
sudo python pygettext.py -a -v -d messages -o plugins/weather_based_rain_delay/i18n/ospy_messages.pot plugins/weather_based_rain_delay/\*.py plugins/weather_based_rain_delay/templates/\*.html 
```