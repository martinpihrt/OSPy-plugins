...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/real_time/i18n/ospy_messages.pot plugins/real_time/\*.py plugins/real_time/templates/\*.html 
