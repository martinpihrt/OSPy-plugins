...
``` bash
sudo python pygettext.py -a -v -d messages -o plugins/email_notifications/i18n/ospy_messages.pot plugins/email_notifications/\*.py plugins/email_notifications/templates/\*.html 
```