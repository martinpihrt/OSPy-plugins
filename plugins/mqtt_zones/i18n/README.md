...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/mqtt_zones/i18n/ospy_messages.pot plugins/mqtt_zones/\*.py plugins/mqtt_zones/templates/\*.html 
