...
``` bash
sudo python pygettext.py -a -v -d messages -o plugins/remote_ftp_control/i18n/ospy_messages.pot plugins/remote_ftp_control/\*.py plugins/remote_ftp_control/templates/\*.html 
```