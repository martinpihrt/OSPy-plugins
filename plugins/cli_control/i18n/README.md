...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/cli_control/i18n/ospy_messages.pot plugins/cli_control/\*.py plugins/cli_control/templates/\*.html 
