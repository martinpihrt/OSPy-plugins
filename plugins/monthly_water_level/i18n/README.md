...
for generate ospy_messages.pot use: sudo python pygettext.py -a -v -d messages -o plugins/monthly_water_level/i18n/ospy_messages.pot plugins/monthly_water_level/\*.py plugins/monthly_water_level/templates/\*.html 
