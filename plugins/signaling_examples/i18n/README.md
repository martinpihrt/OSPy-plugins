...
``` bash
sudo python pygettext.py -a -v -d messages -o plugins/signaling_examples/i18n/ospy_messages.pot plugins/signaling_examples/\*.py plugins/signaling_examples/templates/\*.html 
```