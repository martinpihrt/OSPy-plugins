...
``` bash
sudo python pygettext.py -a -v -d messages -o plugins/usage_statistics/i18n/ospy_messages.pot plugins/usage_statistics/\*.py plugins/usage_statistics/templates/\*.html 
```