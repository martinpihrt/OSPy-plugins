...
Version 1.0.8 initially collapses every saved rule and the New rule card, keeps the rule being saved expanded after redirect and adds a compact localized condition-and-notification summary beside every saved rule name.
