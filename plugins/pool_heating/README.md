...
The plug-in includes a `plugin.json` manifest and reports its worker, regulation,
pool and solar temperatures, selected output, safety shutdown and errors through
the OSPy system health interface.
